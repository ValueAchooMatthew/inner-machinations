...
<div class="flex-col align-middle justify-center">
    {#if is_string_accepted}
        ...
        <div class="text-center mx-auto">
            The string <br> was accepted
        </div>
    {:else if is_string_accepted !== null}
        <svg class="w-24 h-24 self-center mx-auto" data-slot="icon" aria-hidden="true" fill="none" stroke-width="2.2" stroke="red" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="text-center mx-auto">
            The string <br> was not accepted
        </div>
    {:else}
        <div class="w-24 h-36">
