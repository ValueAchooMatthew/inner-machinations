...
<div class="bg-orange-500 text-white font-bold px-4 py-3 rounded-md fixed transition-all 
    duration-300 mx-auto my-auto left-0 right-0 w-fit h-fit bottom-0 border-2 border-black" class:top-full={!workspace_to_delete} class:mt-96={!workspace_to_delete} class:top-0={workspace_to_delete}>
    <span class="text-2xl">
    ...
    <div class="flex justify-around text-lg">
        ...
        <button on:click={()=>{workspace_to_delete = null}}>
            No
        </button>
    </div>
</div>