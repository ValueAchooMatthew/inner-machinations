...
<div
  class="bg-orange-500 flex shadow-lg py-4 pl-2 pr-4 w-full text-gray-100 text-4xl font-bold justify-between align-middle z-50 fixed top-0"
>
  <div class="flex justify-start w-64">
    <svg
      on:click={handleClick}
      class="ml-2 hover:cursor-pointer hover:-rotate-90 w-12 h-12 transition-all duration-200"
      data-slot="icon"
      fill="none"
      stroke-width="2.2"
      stroke="currentColor"
  ...
  <a class="flex gap-2 font-bold self-center justify-end w-64" href="/">
    <svg
      class="self-center w-10 h-10 inline-block"
      data-slot="icon"
      aria-hidden="true"
      fill="none"
      stroke-width="1.5"
