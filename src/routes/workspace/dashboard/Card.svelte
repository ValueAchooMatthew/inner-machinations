...
<div class="flex">
    ...
    <button class="absolute flex justify-center bg-orange-500 rounded-r-md w-12 h-12" on:click={()=>{workspace_to_delete = workspace_name}}>
        <svg class="w-8 h-8 self-center" data-slot="icon" fill="none" stroke-width="1.5" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
